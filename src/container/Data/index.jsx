...
const  Data = () => {
  ...
  return <div className={s.data}>
    <div className={s.total}>
      ...
      <div className={s.title}>Total expenses</div>
      <div className={s.expense}>€{ totalExpense }</div>
      <div className={s.income}>Total revenue€{ totalIncome }</div>
    </div>
    <div className={s.structure}>
      <div className={s.head}>
        <div className={s.tab}>
          <span onClick={() => changeTotalType('expense')} className={cx({ [s.expense]: true, [s.active]: totalType == 'expense' })}>Expen</span>
          <span onClick={() => changeTotalType('income')} className={cx({ [s.income]: true, [s.active]: totalType == 'income' })}>Inco</span>
        </div>
      </div>
      ...
      <div className={s.proportion}>
        <div className={s.head}>
          <div className={s.tab}>
            <span onClick={() => changePieType('expense')} className={cx({ [s.expense]: true, [s.active]: pieType == 'expense'  })}>Expen</span>
            <span onClick={() => changePieType('income')} className={cx({ [s.income]: true, [s.active]: pieType == 'income'  })}>Inco</span>
          </div>
        </div>
